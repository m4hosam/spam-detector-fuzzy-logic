SpamWords = [
    '100% more', 'claim',  'win', '100% free', '100% satisfied', 'Additional income', 'Be your own boss', 'Best price',
    ...
    'Free gift', 'Free hosting', 'Free info', 'Free investment', 'Free membership', 'Free money', 'Free preview',
    'Free quote', 'Free trial', 'Full refund', 'Get out of debt', 'Get paid', 'Giveaway', 'Guaranteed',
    'Increase sales', 'Increase traffic', 'Incredible deal', 'Lower rates', 'Lowest price', 'Make money',
    ...
    'You are a winner', 'You have been selected', 'Bulk email', 'Buy direct', 'Cancel at any time',
    'Check or money order', 'Congratulations', 'Confidentiality', 'Cures', 'Dear friend', 'Direct email',
    'Direct marketing', 'Hidden charges', 'Human growth hormone', 'Internet marketing', 'Lose weight',
    'Mass email', 'Meet singles', 'Multi-level marketing', 'No catch', 'No cost', 'No credit check',
